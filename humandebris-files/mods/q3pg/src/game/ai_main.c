...
// Zygote Start
	viewcheck = ANGLE2SHORT(forward[0]);

	if (viewcheck < 0) {			// If bot is looking left
		ucmd->forwardmove *= -1;	// reverse bots forward movement
	}
// Zygote End
