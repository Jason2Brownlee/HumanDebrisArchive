...
// Zygote start
	y += INGAME_MENU_VERTICAL_SPACING;
	s_ingame.osk.generic.type		= MTYPE_PTEXT;
	s_ingame.osk.generic.flags		= QMF_CENTER_JUSTIFY|QMF_PULSEIFFOCUS;
	s_ingame.osk.generic.x			= 320;
	s_ingame.osk.generic.y			= y;
	s_ingame.osk.generic.id			= ID_OSK;
	s_ingame.osk.generic.callback	= InGame_Event; 
	s_ingame.osk.string				= "OSK MENU";
	s_ingame.osk.color				= color_red;
	s_ingame.osk.style				= UI_CENTER|UI_SMALLFONT;
// Zygote end
	...
	// Zygote - add osk to the in game menu
	Menu_AddItem( &s_ingame.menu, &s_ingame.osk ); 
