...
struct gclient_s {
	...
	// Zygote - for delayed instagib
	int			delaytime;
	gentity_t	*delayattacker;
	qboolean	delayswitch;
	qboolean	delayeffect;

	qboolean	delayhitagain;		// Zygote - hit a second time
	qboolean	delayblasteffect;	// Zygote - different effect 
