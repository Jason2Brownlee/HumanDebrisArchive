...
void FireWeapon( gentity_t *ent ) {
	...
	case WP_ROCKET_LAUNCHER:
		// Zygote
		// Use the value of the cvar to determine
		// Which rocket launcher to use
		switch (g_rocket.integer) {
		case 1:
			// Zygote - Effected by gravity
			RocketLauncher_Fire(ent, fire_rocket_gravity);
			break;
		case 2:
			// Zygote - Homing
			RocketLauncher_Fire(ent, fire_rocket_homing);
			break;
		case 3:
			// Zygote - Rapid
			RocketLauncher_Fire(ent, fire_rocket_rapid);
			break;
		case 4:
			// Zygote - Laser Guided
			RocketLauncher_Fire(ent, fire_rocket_laser);
			break;
		default:
			// Zygote - Standard rocket launcher
